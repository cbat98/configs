...
_G.packer_plugins = {
  ...
  ["leap.nvim"] = {
    ...
    loaded = true,
    path = "/home/charlie/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  ["onedark.nvim"] = {
    loaded = true,
    path = "/home/charlie/.local/share/nvim/site/pack/packer/start/onedark.nvim",
  ...
  ["vim-be-good"] = {
    loaded = true,
    path = "/home/charlie/.local/share/nvim/site/pack/packer/start/vim-be-good",
